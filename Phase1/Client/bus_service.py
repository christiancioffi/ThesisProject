...
from machine import I2C, I2S, PWM
...
class I2sAdapter(BusAdapter):
    def __init__(self, bus: I2S):
        super().__init__(bus)
    ...
    def read_into(self, buffer) ->int:
        ...
        """
        return self.bus.readinto(buffer)
    

class PwmAdapter(BusAdapter):

    def __init__(self, bus: PWM):
        super().__init__(bus)
        self.bus.freq(1000)
        self.bus.duty_u16(65535)


    def set_duty(self, duty):
        """
            Set duty value of pwm.

            :param int duty: duty value between 0 and 65535
        """
        self.bus.duty_u16(duty)
        #return self.bus.writeto(device_addr, buf)
